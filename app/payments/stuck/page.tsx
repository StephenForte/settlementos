...
import { explorerTxUrl, isSourceSupersededByRegenesis, isSupersededByRegenesis } from "@/lib/networks";
...
export default async function StuckPaymentsPage() {
  ...
  // Hide only a wiped *source* — escrow and compensation live there. A live
  // source with a wiped ForteL2 destination is still repairable.
